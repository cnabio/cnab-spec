...
- `labels` (OPTIONAL): Labels are a set of key/value pairs of type string that MAY be used for querying. Labels defined on an installation MUST be included in the claim.  MUST follow the [CNAB Label Format].
- `namespace` (OPTIONAL): The namespace. Claims MUST be defined in the same namespace as the installation. MUST follow the [CNAB Namespace Format].
...
- `labels` (OPTIONAL): Labels are a set of key/value pairs of type string that MAY be used for querying. MUST follow the [CNAB Label Format].
...
- `namespace` (OPTIONAL): The namespace. Claim results MUST be in the same namespace as the installation. MUST follow the [CNAB Namespace Format].
